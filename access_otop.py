...
username = "XR36101"  # fyers_id
totp_key = "B63CP33OUTU3DBGC2ZTRKJFKE63K2LJ4"  # totp_key ("OMKR****CDVDFGECLWXKI6OVB7T4DTKU5")
pin = 5005  # your integer pin
client_id = "LB65IDSEJH-100"  # "L9NY****W-100" (Client_id here refers to APP_ID of the created app)
